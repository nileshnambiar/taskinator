...
var createTaskActions = function(taskId) {
    ...
    // create a new div element with class name "task-actions"
    ...
    // create the drop down selection criteria
...
var deleteTask = function(taskId) {
    ...
    for (var i = 0; i < tasks.length; i++) {
        // if tasjs[i].if doesn't match the value taskId, lets keep that task and push it into the new array
        if (tasks[i].id !== parseInt(taskId)) {
...
var loadTasks = function() {
    ...
    // check if the value of tasks is null
    if (!savedTasks) {
        return false;
    }
